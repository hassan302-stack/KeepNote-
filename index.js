...
// rolling.addEventListener('click', joking=async()=>{
// try{  var setHeader={
//     headers:{
//     Accept :"application/json"
//     }
// }
//   var res = await fetch('https://icanhazdadjoke.com',setHeader)
...
// document.getElementById('seleTemp').addEventListener('click',()=>{
//   var seleTemp = document.getElementById('seleTemp').value
//   if(seleTemp==="c"){
//     txtTemp.placeholder = 'Celsius To Farenhite'}
//     if(seleTemp==="f"){
//       txtTemp.placeholder = 'Farenhite To Celsius'}

// })
// convert.addEventListener('click',()=>{
//  // debugger
//   var val = parseInt(txtTemp.value)
//   var seleTemp = document.getElementById('seleTemp').value  
//  if(seleTemp==="c"){
//   txtTemp.placeholder = 'Enter Celsius'
//    var result = eval((val*1.8)+32)
//    res.innerHTML = result
//  }
//  if(seleTemp=="f"){
//   txtTemp.placeholder = 'Enter Farenhite'
//   var result = eval((val-32)*0.5)
//   res.innerHTML = result
// }
// })
...
//   ele.innerHTML = 0
//   var val = +ele.getAttribute('data-target')
//   var i = 0;
//   console.log(val);
...
////////////////////// ***** Google Keep Clone ************
 ...
 add=()=>{
  ...
  <div class="operation">
     <button id="edit" class="fa fa-edit" value="edit"> Edit </button>
     <button id="delete" value="delete" class="fa fa-trash-alt"> Delete </button>
     </div>
  ...
  `
    ...
    delet.addEventListener('click',(event)=>{
     ...
     // container.removeChild(event.target.parentNode.parentNode)
      //container.remove(event.target)
  //   console.log(event.target.parentNode.parentNode);
       notes.remove()

    })
    msg.addEventListener('change',(eve)=>{
                    notes.innerHTML  =  eve.target.value
    })
